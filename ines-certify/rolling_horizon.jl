...
@variable(model,v__investment__cheap_unit)
@variable(model,v__investment__expensive_unit)

@objective(model,Min,p__investment_cost__cheap_unit*(v__investment__cheap_unit-p__existing_units__cheap_unit)+p__investment_cost__expensive_unit*(v__investment__expensive_unit-p__existing_units__expensive_unit)+sum(p__commodity_price__cheap_source[t]*v__flow__cheap_source[t]+p__commodity_price__expensive_source[t]*v__flow__expensive_source[t] for t in s__t))
...
@constraint(model,c__capacity_existing__cheap_unit,p__existing_units__cheap_unit<=v__investment__cheap_unit)
...
p__commodity_price__cheap_source = [10.0 for t in s__t]#10
p__commodity_price__expensive_source = [1.0 for t in s__t]#1
p__flow_profile__demand = [20.0 for t in s__t]#20
